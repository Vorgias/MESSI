...
isax_node * insert_to_single_pRecBuf_geopat(parallel_first_buffer_layer_ekosmas_lf_geopat *fbl,
									sax_type *sax,
									file_position_type *pos,
									root_mask_type mask, 
									isax_index *index, 
									...
									int workernumber,
									int total_workernumber,
									unsigned long number_of_series,
									unsigned long time_series_num,
									int flag);
